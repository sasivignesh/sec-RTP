...
static uint8_t patternKDFLabel[KDF_TEST_NUMBER][28] = {
...
static uint8_t patternKDFContext[KDF_TEST_NUMBER][56] = {
...
static uint16_t patternCRCLength[CRC_TEST_NUMBER] = {128, 24, 480};

static uint8_t patterCRCinput[CRC_TEST_NUMBER][480] = {
...
static uint32_t patternCRCoutput[CRC_TEST_NUMBER] = {0x5065ab04, 0x9c9edccd, 0xda5c92ea};
...
static int testAlgoType(uint8_t algoType, uint8_t *packetTypes, uint8_t packetTypesCount, uint8_t *contextTypes, uint8_t contextTypesCount, uint8_t expectedType) {
	...
	if (contextTypes != NULL) {
		retval = bzrtp_setSupportedCryptoTypes(zrtpContext, algoType, contextTypes, contextTypesCount);
	...
	BC_ASSERT_FALSE(bzrtp_cryptoAlgoAgreement(zrtpContext, zrtpContext->channelContext[0], static_cast<bzrtpHelloMessage_t*>(helloPacket->messageData)));
...
static uint8_t keyAgreementDefault[3] = {ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_DH2k, ZRTP_KEYAGREEMENT_Mult};
static void test_algoAgreement(void) {
	...
	while (agreement_type_with_packet->typesCount > 0) {
		// Use a default context to DH3k, DH2k, Mult so when supported algo are more than 7 we are sure that the context holds at least theses
		BC_ASSERT_TRUE(testAlgoType(ZRTP_KEYAGREEMENT_TYPE, agreement_type_with_packet->types, agreement_type_with_packet->typesCount, keyAgreementDefault, 3, agreement_type_with_packet->expectedType));
...
static void test_algoSetterGetter(void) {
	...
	/* Define another set used only if PQ KEM agreements are availables */
	struct st_algo_setter_getter pqkem_agreement_types[] = {
		{ {ZRTP_KEYAGREEMENT_KYB1}, 1, {ZRTP_KEYAGREEMENT_KYB1, ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_Mult}, 3 },
		...
		{ {ZRTP_KEYAGREEMENT_HQC1}, 1, {ZRTP_KEYAGREEMENT_HQC1, ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_Mult}, 3 },
		{ {ZRTP_KEYAGREEMENT_HQC2}, 1, {ZRTP_KEYAGREEMENT_HQC2, ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_Mult}, 3 },
		{ {ZRTP_KEYAGREEMENT_HQC3}, 1, {ZRTP_KEYAGREEMENT_HQC3, ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_Mult}, 3 },
		{ {ZRTP_KEYAGREEMENT_K255_KYB512}, 1, {ZRTP_KEYAGREEMENT_K255_KYB512, ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_Mult}, 3 },
		{ {ZRTP_KEYAGREEMENT_K448_KYB1024}, 1, {ZRTP_KEYAGREEMENT_K448_KYB1024, ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_Mult}, 3 },
		{ {ZRTP_KEYAGREEMENT_K255_HQC128}, 1, {ZRTP_KEYAGREEMENT_K255_HQC128, ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_Mult}, 3 },
		{ {ZRTP_KEYAGREEMENT_K448_HQC256}, 1, {ZRTP_KEYAGREEMENT_K448_HQC256, ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_Mult}, 3 },
		...
		{ {ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_KYB1, ZRTP_KEYAGREEMENT_KYB2, ZRTP_KEYAGREEMENT_KYB3}, 4, {ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_KYB1, ZRTP_KEYAGREEMENT_KYB2, ZRTP_KEYAGREEMENT_KYB3, ZRTP_KEYAGREEMENT_Mult}, 5 },
		{ {ZRTP_KEYAGREEMENT_HQC1, ZRTP_KEYAGREEMENT_HQC3}, 2, {ZRTP_KEYAGREEMENT_HQC1, ZRTP_KEYAGREEMENT_HQC3, ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_Mult}, 4 },
		{ {ZRTP_KEYAGREEMENT_HQC3, ZRTP_KEYAGREEMENT_HQC1}, 2, {ZRTP_KEYAGREEMENT_HQC3, ZRTP_KEYAGREEMENT_HQC1, ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_Mult}, 4 },
		{ {ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_HQC1, ZRTP_KEYAGREEMENT_HQC3}, 3, {ZRTP_KEYAGREEMENT_DH3k, ZRTP_KEYAGREEMENT_HQC1,ZRTP_KEYAGREEMENT_HQC3, ZRTP_KEYAGREEMENT_Mult}, 4 },
		{ {ZRTP_UNSET_ALGO}, 0, {ZRTP_UNSET_ALGO}, 0, }
	};
	...
	struct st_algo_setter_getter cipher_types_with_PQ[] = {
		...
		{ {ZRTP_CIPHER_AES2}, 1, {ZRTP_CIPHER_AES1, ZRTP_CIPHER_AES3}, 2 },
		{ {ZRTP_CIPHER_AES3}, 1, {ZRTP_CIPHER_AES3, ZRTP_CIPHER_AES1}, 2 },
		{ {ZRTP_CIPHER_2FS1}, 1, {ZRTP_CIPHER_AES1, ZRTP_CIPHER_AES3}, 2 },
		{ {ZRTP_CIPHER_2FS2}, 1, {ZRTP_CIPHER_AES1, ZRTP_CIPHER_AES3}, 2 },
		{ {ZRTP_CIPHER_2FS3}, 1, {ZRTP_CIPHER_AES1, ZRTP_CIPHER_AES3}, 2 },
		...
		{ {ZRTP_CIPHER_AES1, ZRTP_CIPHER_AES2}, 2, {ZRTP_CIPHER_AES1, ZRTP_CIPHER_AES3}, 2 },
		{ {ZRTP_CIPHER_AES1, ZRTP_CIPHER_2FS3}, 2, {ZRTP_CIPHER_AES1, ZRTP_CIPHER_AES3}, 2 },
		{ {ZRTP_CIPHER_AES2, ZRTP_CIPHER_2FS3}, 2, {ZRTP_CIPHER_AES1, ZRTP_CIPHER_AES3}, 2 },
	...
	struct st_algo_setter_getter hash_types_with_PQ[] = {
		...
		{ {ZRTP_HASH_S384}, 1, {ZRTP_HASH_S384, ZRTP_HASH_S256, ZRTP_HASH_S512}, 3 },
		{ {ZRTP_HASH_S512}, 1, {ZRTP_HASH_S512, ZRTP_HASH_S256}, 2 },
		{ {ZRTP_HASH_N256}, 1, {ZRTP_HASH_S256, ZRTP_HASH_S512}, 2 },
